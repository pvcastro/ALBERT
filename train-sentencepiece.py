...
def train(prefix=PREFIX, vocab_size=VOCABSIZE, ctl_symbols=CTLSYMBOLS):
    ...
    command = f'--input={files} --model_prefix={prefix} --vocab_size={vocab_size} --pad_id=0 --unk_id=1 --bos_id=2 --eos_id=3 --pad_piece=<pad> --unk_piece=<unk> --bos_piece=[CLS] --eos_piece=[SEP] --control_symbols={ctl_symbols} --user_defined_symbols=(,),\",-,.,–,£,€,$ --normalization_rule_name=nmt_nfkc_cf'
